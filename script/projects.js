...
const bridgeForBetter = document.querySelector('.bridgeForBetter');
const breather = document.querySelector('.breather');
const gitaGpt = document.querySelector('.gitaGpt');
const mySpace = document.querySelector('.mySpace');
const voting = document.querySelector('.voting');
const stressBall = document.querySelector('.stressBall');
...
stressBall.addEventListener("click", function () {
