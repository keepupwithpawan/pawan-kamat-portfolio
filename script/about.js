...
// NAMASTE HOVER
var namaste = document.getElementById('namaste');

namaste.addEventListener('mouseover', function() {
  this.textContent = 'Namaste';
  this.style.color = '#571F4E';
});

namaste.addEventListener('mouseout', function() {
  this.textContent = 'नमस्ते';
  this.style.color = '#FFC600';
});
